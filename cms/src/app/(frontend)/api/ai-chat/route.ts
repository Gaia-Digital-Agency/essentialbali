...
function buildPrompt(question: string, contextJson: string): string {
  return [
    ...
    "       <spec>{\"type\":\"article\",\"area\":\"<area-slug>\",\"topic\":\"<topic-slug>\",\"persona\":\"<persona-slug>\",\"brief\":\"<400-1500 chars of detailed brief>\",\"target_words\":600}</spec>",
    ...
    "",
    "Spec field rules:",
    "  - type: always \u0027article\u0027 for now (the only thing the dispatch pipeline supports).",
    ...
    "      maya/sang-ayu-rai for people-culture; tomas-veld for nightlife/dine after-dark;",
    "      kira-bumi for activities/outdoor; nadia-puspita for health-wellness.",
    "  - brief: 400\u20131500 chars. Specific. Name venues, prices, times, characters. Not vague.",
    "  - target_words: 500\u2013800 typical.",
    "",

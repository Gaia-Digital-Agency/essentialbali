...
import { e as getArticleByKeyword, b as getArticleByFields, f as getArticleById, h as editArticleById, i as createArticle } from "./article.service-DlhMD6VX.js";
...
import { M as Media, A as AdminFeaturedImage } from "./FeaturedImage-756EfM0U.js";
...
import { i as useNotification, c as useTaxonomies } from "./TimeContext-B5j8j_GZ.js";
...
import { g as getAllTags } from "./tags.service-D334lDpz.js";
...
import "./media.service-Bg8ZwuBl.js";
import "./MediaForm-pn_2Hilv.js";
...
const API_URL$1 = "http://34.124.244.233/essentialbali";
...
const API_URL = "http://34.124.244.233/essentialbali";
...
const EditArticle = ({ action }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-12 gap-x-12", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "col-span-4", children: /* @__PURE__ */ jsxs(ComponentCard, { children: [
      ...
      /* @__PURE__ */ jsx(InputWrapper, { label: "Bali Area *", children: /* @__PURE__ */ jsx(Select, { required: true, options: availableCountries, value: country ? (_e = availableCountries.find((coun) => coun.value == country)) == null ? void 0 : _e.value : void 0, placeholder: "Select Bali Area", onChange: countryChangeHandler }) }),
      renderCity(),
      renderRegion(),
      renderTags(),

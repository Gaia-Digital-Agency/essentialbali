...
const DiscoverArticle: React.FC<{ article: ArticleApiResponseProps }> = ({
  article,
}) => {
    ...
    <>
      ...
      <div className="category-wrapper">
        <p className="capitalize text-front-shadowed-slate">
          {
            taxonomies.categories?.find((cat) => cat.id == article.category_id)
              ?.title
          }
        </p>
      </div>
...
const Single: React.FC = () => {
  ...
  const [discover, setDiscover] = useState<ArticleApiResponseProps[]>(

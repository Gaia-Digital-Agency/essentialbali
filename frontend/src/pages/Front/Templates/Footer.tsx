          ...
          <div className="md:col-span-6 col-span-12">
            <div className="text-wrapper">
              <p className="text-front-body-big mb-8">
                Welcome to essentialbali, your practical guide to discovering
                Bali area by area. We help travelers, expats, and locals find
                where to stay, eat, explore, and experience the island with
                confidence.
              </p>
              <p className="text-front-body-big mb-8">
          ...
          <div className="md:col-span-3 col-span-12">
            ...
            <div className="links-wrapper">
              <div className="link mb-2">
                <Link to="/privacy-policy" className="text-front-body-big">
                  Privacy Policy
                </Link>
              </div>
              <div className="link">
      ...
      <div className="outer py-5 bg-front-red">
        <div className="container">
          <div className="flex justify-between items-center">
            <div className="item text-front-small text-white">
              © 2026 - essentialbali
            </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-y-2 mt-3">
            <div className="text-front-small text-white">
              Visitor Count: {visitorCount}
            </div>
            <div className="text-front-small text-white md:text-right">
              Location: {userLocation} | Time: {userTime}
            </div>
          </div>
        </div>
      </div>

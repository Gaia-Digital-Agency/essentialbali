...
export const TrendingMain: React.FC<TrendingMainProps> = ({content, admin = false}) => {
        ...
        return (
            ...
            <div className="md:container mx-auto !px-0 md:!px-7">
                <div className="title-wrapper text-center mb-8">
                    <h3 className="text-front-section-title font-serif font-semibold">Trending in <span className="text-front-red">Bali</span></h3>
                </div>

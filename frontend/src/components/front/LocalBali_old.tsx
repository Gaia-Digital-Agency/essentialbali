            ...
            <div className="container">
              <div className="title-wrapper text-center mb-8">
                <p className="text-front-section-title font-serif font-semibold">
                  <span className="text-front-red">Bali News</span>
                </p>
              </div>
              <div className="grid grid-cols-12 md:gap-x-10 gap-y-10 gap-x-6 md:mb-10 mb-12 overflow-x-hidden">
                {content?.map((article) => {
                  if (article) {
                    return (
                      <div
                        key={"area-highlights-" + article.id}
                        className={`md:col-span-6 lg:col-span-3 col-span-12 line-right-5 relative`}
                      >
                        ...
                        <div className="category-wrapper mb-2">
                          <p className="text-front-grey">
                            {findCategory(article)?.title}
                          </p>
                        </div>
                        <div className="title-wrapper">
                          <Link to={getPermalink(article)}>
                            <p className="text-front-title text-front-grey font-serif">
                              {article.title}
                            </p>
                          </Link>
                        </div>
